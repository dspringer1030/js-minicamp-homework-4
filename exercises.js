...
function map(arr, cb) {
    ...
    var newArray = arr.map(function(cb) {
        return cb * cb;
    });
    return newArray;
//    This seems wrong according to the directions - but I noticed why it wasn't passing the test. Shouldn't it just be return cb, not return cb * cb?
}
...
function getUserConstructor() {
    ...
    User.prototype.sayHi = function() {'Hello, my name is ' + this.name;};
